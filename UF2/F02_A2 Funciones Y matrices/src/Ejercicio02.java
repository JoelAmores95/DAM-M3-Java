...
////		R → Raves
	 ...
	 * @return boolean
	 */
	public static boolean esPodenPlantarBledesFila(char matriz[][], int numFila){
		...
		for (int col = 0; col < matriz[numFila].length; col++) {
			...
			if(matriz[numFila][col] != '-' && matriz[numFila][col] != 'T') {
				return false;
			} 
	...
	public static int numFilaOnPodenPlantarBledesMatriu(char matriz[][]) {
